/**
  ...
  ******************************************************************************
  */
#ifndef AI_YOLOFACE50K_H
#define AI_YOLOFACE50K_H

#include "yoloface50k_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_YOLOFACE50K_MODEL_NAME          "yoloface50k"
#define AI_YOLOFACE50K_ORIGIN_MODEL_NAME   "yoloface_int8"

/******************************************************************************/
#define AI_YOLOFACE50K_ACTIVATIONS_ALIGNMENT   (4)
#define AI_YOLOFACE50K_INPUTS_IN_ACTIVATIONS   (4)
#define AI_YOLOFACE50K_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_YOLOFACE50K_IN_NUM        (1)

AI_DEPRECATED
#define AI_YOLOFACE50K_IN \
  ai_yoloface50k_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_YOLOFACE50K_IN_SIZE { \
  AI_YOLOFACE50K_IN_1_SIZE, \
}
#define AI_YOLOFACE50K_IN_SIZE_BYTES { \
  AI_YOLOFACE50K_IN_1_SIZE_BYTES, \
}
#define AI_YOLOFACE50K_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_YOLOFACE50K_IN_1_HEIGHT      (56)
#define AI_YOLOFACE50K_IN_1_WIDTH       (56)
#define AI_YOLOFACE50K_IN_1_CHANNEL     (3)
#define AI_YOLOFACE50K_IN_1_SIZE        (9408)
#define AI_YOLOFACE50K_IN_1_SIZE_BYTES  (9409)

/******************************************************************************/
#define AI_YOLOFACE50K_OUT_NUM       (1)

AI_DEPRECATED
#define AI_YOLOFACE50K_OUT \
  ai_yoloface50k_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_YOLOFACE50K_OUT_SIZE { \
  AI_YOLOFACE50K_OUT_1_SIZE, \
}
#define AI_YOLOFACE50K_OUT_SIZE_BYTES { \
  AI_YOLOFACE50K_OUT_1_SIZE_BYTES, \
}
#define AI_YOLOFACE50K_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_YOLOFACE50K_OUT_1_HEIGHT      (7)
#define AI_YOLOFACE50K_OUT_1_WIDTH       (7)
#define AI_YOLOFACE50K_OUT_1_CHANNEL     (18)
#define AI_YOLOFACE50K_OUT_1_SIZE        (882)
#define AI_YOLOFACE50K_OUT_1_SIZE_BYTES  (882)

/******************************************************************************/
#define AI_YOLOFACE50K_N_NODES (57)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup yoloface50k
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_yoloface50k_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_yoloface50k_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_error ai_yoloface50k_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_error ai_yoloface50k_create(
 ...
 */
AI_API_ENTRY
ai_handle ai_yoloface50k_destroy(ai_handle network);
 ...
 * @ref ai_yoloface50k_create. Both the activations memory buffer 
 ...
 * using @ref ai_yoloface50k_get_error
 */
AI_API_ENTRY
ai_bool ai_yoloface50k_init(
 ...
 */
AI_API_ENTRY
ai_error ai_yoloface50k_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_yoloface50k_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_yoloface50k_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_YOLOFACE50K_*
 * defines into file @ref yoloface50k.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_yoloface50k_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_YOLOFACE50K_H */
